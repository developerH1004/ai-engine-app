    ...
    <header style={{
      ...
      <div style={{
        ...
        <nav style={{ display: 'flex', alignItems: 'center', gap: '4px' }} className="hidden md:flex">
          ...
          onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = '#00ff99'; (e.currentTarget as HTMLElement).style.boxShadow = '0 0 16px rgba(0,255,136,0.4)'; }}
      ...
      {open && (
        <div className="md:hidden" style={{
          ...
          <Link href="/" style={{ padding: '8px 12px', borderRadius: '6px', fontSize: '13px', color: '#8b949e', textDecoration: 'none' }}>{tx('navExplore')}</Link>
          <Link href="/request" style={{ padding: '8px 12px', borderRadius: '6px', fontSize: '13px', color: '#8b949e', textDecoration: 'none' }}>{tx('navRequest')}</Link>
