      ...
      <main className="max-w-screen-xl mx-auto px-4 pb-20">
        <section style={{ padding: "16px 0 12px", textAlign: "center", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ display: 'inline-block', textAlign: 'left' }}>
            <h1 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 'clamp(28px, 3.2vw, 40px)', color: '#e6edf3', lineHeight: 1.1, marginBottom: '6px', letterSpacing: '1.5px' }}>{ko ? '이거봐!!! AI가 다 모였어' : 'WAIT, THEY ARE ALL HERE?!'}</h1>
            <p style={{ fontSize: '11px', color: '#00cc6a', fontFamily: 'monospace', marginBottom: '10px', lineHeight: 1, letterSpacing: '0.08em' }}>{ko ? 'AI 지도 완전판' : 'The Complete AI Atlas'}</p>
          </div>
